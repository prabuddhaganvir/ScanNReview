...
export default async function QRNotFound({ searchParams }: { searchParams: Promise<{ from?: string }> }) {
    ...
    <main className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      >
        ...
        <p className="text-muted-foreground mb-6">
          This QR code is not linked to any business.  
          Please verify the code or generate a fresh one.
        </p>
